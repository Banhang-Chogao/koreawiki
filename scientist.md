...
**Trigger:** CI/CD failure (workflow run `29499239206`)

**Root causes:**
- build	Run QA	2026-07-16T12:43:23.8185178Z ##[error]Process completed with exit code 1.
...
**Report:** `reports/self-healing/20260716T124353Z-29499239206`
