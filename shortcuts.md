...
| `mm` | `opencode` command | Xuất bản **news tiếng Hàn** → VI + full gallery | `.opencode/commands/mm.md`: viết lại **human/khách quan, đủ facts**, body **≥ 2.000 từ** (`wordcount_article.py`), gallery full, QA | `implemented` | `.opencode/commands/mm.md`, `scripts/wordcount_article.py`, `scripts/fetch_cover.py` |
| `nn` | `opencode` command | Xuất bản **bài tiếng Anh** (báo / **ArchDaily**) → VI + full gallery | `.opencode/commands/nn.md`: EN→VI human, **≥ 2.000 từ**, gallery + baseURL hook, faq/footer/QA | `implemented` | `.opencode/commands/nn.md`, `scripts/wordcount_article.py`, `themes/.../render-image.html` |
| `th` | `opencode` command | Xuất bản **thị trường Thái Lan** (TH hoặc EN về Thái) → VI + full gallery | `.opencode/commands/th.md`: TH/EN→VI human, **≥ 2.000 từ**, gallery + baseURL hook, TM nhẹ (không bịa Hangul), faq/footer/QA | `implemented` | `.opencode/commands/th.md`, `scripts/wordcount_article.py`, `scripts/fetch_cover.py` |
