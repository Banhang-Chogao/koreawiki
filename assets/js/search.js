...
var html='';r.forEach(function(res){var i=res.item;html+='<a class="search-item" href="'+i.permalink+'">';html+='<span class="search-item-title">'+i.title+'</span>';if(i.description){html+='<p class="search-item-desc">'+i.description+'</p>';}
html+='<span class="search-item-meta">';if(i.section)html+=i.section;if(i.date)html+=' &middot; '+i.date;html+='</span></a>';});results.innerHTML=html;}
